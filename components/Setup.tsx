...
import { 
  ...
  XCircle // Added missing XCircle icon
} from 'lucide-react';
...
type SetupStep = 'welcome' | 'auth' | 'vault' | 'ai' | 'guide';
          ...
          {currentStep === 'auth' && (
            <div className="space-y-10 animate-in fade-in zoom-in-95 duration-500 flex-1 flex flex-col">
              <div className="text-center">
                ...
                <p className="text-slate-500 text-sm max-w-md mx-auto">Link your corporate identity provider.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto w-full">
                {[
                  ...
                  >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-300">{provider.label}</span>
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-10 animate-in fade-in zoom-in-95 duration-500 flex-1 flex flex-col">
              ...
              {aiConfig.provider !== AIProvider.NONE && (
                <div className="max-w-2xl mx-auto w-full bg-slate-800/30 p-8 rounded-[2rem] border border-slate-700 grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-top-4 duration-300">
                  {/* FIX: API Key input is hidden for Gemini provider to comply with guidelines that prohibit manual entry for Gemini keys. */}
